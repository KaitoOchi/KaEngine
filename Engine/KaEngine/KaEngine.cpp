...
namespace nsKaEngine {
	...
	void KaEngine::Execute()
	{
		...
		shaderProgram = new Shader("Assets/shader/default.vert", "Assets/shader/default.frag");
		...
		//Texture
		Texture testTexture("Assets/sprite/test.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
